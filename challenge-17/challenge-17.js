...
// ?
console.log(text.replace(/Manuel Marques de Sousa/, 'Diego de Paula'));
/*
...
// ?
console.log(text.replace(/O Centauro de Luvas/, (total) => {
...
// ?
var regexDate = /(\d\d) de (J|junho|J|julho) de (\d\d\d\d)/g;
